...
tags: [mikroe, mikroe click board, thermo 5 click, fathym, iot ensemble, microsoft azure, machine learning, devices, sensors, models, grafana]
...
![Grafana Dashboard](/img/screenshots/Mikroe-Grafana-Dashboard.png)
