...
tags: [phoenix contact, plcnext, fathym, iot ensemble, plc controllers, tableau, dashboard, devices, sensors]
keywords:
    - Phoenix Contact
    - PLCNext
    - PLC
...
June 29, 2021 by Jeremy Tomlinson, _Director of Engineering @ Fathym_
