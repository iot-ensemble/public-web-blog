---
slug: raspberry-pi-fathym-power-bi
...
- A [Fathym IoT Ensemble](https://www.fathym.com/dashboard/iot) account (we’re using the free, shared version)
...
If you want to move forward without the physical device, you can still see what the end-to-end IoT experience looks like by leveraging our emulated data.  Simply enable the [emulated data](https://www.fathym.com/iot/docs/getting-started/emulated-data) and follow instructions in connecting to emulated data in the cold query API.
...
Follow these steps to create a new device in IoT Ensemble. For more details on the full IoT Ensemble experience, check out our [full documentation](https://www.fathym.com/iot/docs/getting-started/connecting-first-device).
...
Once this is complete, click the red **Deploy** button in the top right corner. Your Pi is now sending real time data to IoT Ensemble!  Simply [enable live telemetry](https://www.fathym.com/iot/docs/getting-started/viewing-device-data) and investigate your data.

![Dashboard First Device Telemetry](https://www.fathym.com/iot/img/screenshots/dashboard-first-device-telemetry.png)
...
IoT Ensemble Storage Access can be leveraged to connect to many diffrent types of services, check the [full documentation](https://www.fathym.com/docs/getting-started/connecting-downstream-services) for more details.
...
To continue your journey, leverage [IoT Ensemble's](https://www.fathym.com/dashboard/iot) shared plans to expand your number of devices and data velocity. When you’re ready, move onto an enterprise plan to take advantage of IoT Ensemble’s simplicity but with access to best practice cloud infrastructure in your own cloud environment.
